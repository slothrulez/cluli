...
// render via the CPU (SwiftShader). Cluli's UI is light enough that
...
class ApplicationController {
  ...
  this.codingLanguage = "cpp";
    ...
    this.firstRunManager = new FirstRunManager({
      ...
      envPath: ENV_PATH,
      sentinelPath: path.join(app.getPath("userData"), ".cluli-firstrun-completed"),
    });
  ...
  setupGlobalShortcuts() {
    const shortcuts = {
      // Ctrl/Cmd+Shift+S opens Settings. Keep screenshot capture available
      // from the command bar and on a dedicated alternate global shortcut.
      "CommandOrControl+Shift+S": () => windowManager.showSettings(),
      "CommandOrControl+Shift+Alt+S": () => this.triggerScreenshotOCR(),
